...
vector<Ward> generateWard() {
    ...
    if (file.is_open()) {
        ...
        for (int i = 2;i < 11;i++) {
            ...
            point4.x = midPoint1.x + length / 2;
            point1.y = midPoint1.y;
            point4.y = midPoint1.y;
            point3.x = midPoint2.x + length / 2;
            point2.x = midPoint2.x - length / 2;
            point3.y = midPoint2.y;
            point2.y = midPoint2.y;
        ...
        point1.x=point2.x=exit1.x;
        point1.y=point4.y=entrance1.y;
        point4.x=point3.x=exit2.x;
        point3.y=point2.y=entrance2.y;
        wall.push_back(point1);
        wall.push_back(point2);
        wall.push_back(point3);
        wall.push_back(point4);
