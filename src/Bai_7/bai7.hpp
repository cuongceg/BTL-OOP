...
public:
    ...
    void setImpactOfAGV(AGVEvent event) {
        impactOfAGV = event;
    }
    // Point getTempPoints() const { return tempPoints; }


    // Add virtual method, default = no disability
    virtual Walkability getWalkability() const { return Walkability::noDisability; }
};

class Patient: public Pedestrian{
    Walkability walkability;
public:
    // Add public method to get walkability
    Walkability getWalkability() const override { return walkability; }
};
